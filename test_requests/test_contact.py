...
def test_defect_member(tmp):
    ...
    get_member_params = {"access_token": get_token(), "userid": "8517"}
...
def test_update_member():
    update_member_url = (
        "https://qyapi.weixin.qq.com/cgi-bin/user/update?access_token={}".format(
            get_token()
        )
    )
    data = {
...
def test_create_member():
    create_member_url = (
        "https://qyapi.weixin.qq.com/cgi-bin/user/create?access_token={}".format(
            get_token()
        )
    )
...
def test_delete_member():
    ...
    delete_member_params = {"access_token": get_token(), "userid": "22"}
