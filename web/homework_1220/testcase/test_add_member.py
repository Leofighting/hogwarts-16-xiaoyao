...
class TestAddMember:
    ...
    @pytest.mark.parametrize("username, acctid, phone, email", (
    ...
    def test_add_member(self, username, acctid, phone, email):
        ...
        :return:
        """
        res = self.main.goto_add_member().add_member(username, acctid, phone, email).get_member()
        assert USERNAME in res

    @pytest.mark.parametrize("username, acctid, phone, email, expected_res", (
    ...
    def test_add_member_fail(self, username, acctid, phone, email, expected_res):
        res = self.main.goto_add_member().add_member_fail(username, acctid, phone, email)
        # print(res)
        try:
            for i in res:
