...
class TestContact:
    ...
    def test_contact(self):
        contact_element = self.driver.find_element(
            MobileBy.XPATH, "//*[contains(@text, '通讯录') and @resource-id='com.tencent.wework:id/elq']")
        ...
        handle_add_element = self.driver.find_element(MobileBy.XPATH, "//*[@text='手动输入添加']")
        handle_add_element.click()

        self.driver.find_element(
            MobileBy.XPATH, "//*[contains(@text, '姓名')]/..//*[@text='必填']").send_keys(USERNAME)

        self.driver.find_element(
            MobileBy.XPATH, "//*[contains(@text, '性别')]/..//*[@text='男']").click()
        ...
        self.driver.find_element(
            MobileBy.XPATH, "//*[contains(@text, '手机')]/..//*[@text='手机号']").send_keys(PHONE)
