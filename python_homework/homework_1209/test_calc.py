...
class TestCalc:
    ...
    @pytest.mark.parametrize("a, b, expect",
                             get_data(yaml_path, "add_exception"),
                             ids=["字符串"])
    ...
    @pytest.mark.parametrize("a, b, expect",
                             get_data(yaml_path, "sub_exception"),
                             ids=["字符串"])
    ...
    @pytest.mark.parametrize("a, b, expect",
                             get_data(yaml_path, "mul_exception"),
                             ids=["字符串"])
    ...
    @pytest.mark.parametrize("a, b, expect",
                             get_data(yaml_path, "div_exception"),
                             ids=["字符串", "除数为0"])
